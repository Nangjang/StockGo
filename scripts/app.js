...
function() {
    ...
    function e(e, o, a, n, s, i) {
        ...
        function t(o, n) {
            if (n)
                if (isNaN(n)) a.error("Please, Enter Valid Number");
                else {
                    let s = o.phone_code + n;
                    h.mobile = s.substr(1), e.postt("startstockgo/" + h.mobile + "/" + o.phone_code.substr(1)).then(function(e) {
                        "yes" == e.verify ? (a.success(e.message), window.location = "https://" + h.mobile + ".mystockgo.com") : "no" == e.verify && (h.signin = !1, h.verify = !0, a.success(e.message), setTimeout(function() {
                            h.resend = !0
                        }, 3e4))
                    })
                }
        ...
        function l(o) {
            o ? isNaN(o) || 6 != o.length ? a.error("Enter Valid Number.") : (h.mobile.id, e.postt("verifycode/" + h.mobile + "/" + o).then(function(e) {
                "success" == e.status ? (a.success(e.message), window.location = "https://" + h.mobile + ".mystockgo.com/admin/#/login/" + e.userId, r(), h.signin = !1) : a.info(e.message)
